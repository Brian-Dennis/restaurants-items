...
from database_setup import Base, Users, Restaurant, MenuItem
...
app.config['MYSQL_DB'] = 'restaurantmenu'
...
engine = create_engine('mysql://root@localhost/restaurantmenu')
    ...
    if request.method == 'POST':
        ...
        if result > 0:
            ...
            if sha256_crypt.verify(password_candidate, password):
                ...
                error = 'Invalid login'
                return render_template('email-login.html', error=error)
            # Close connection
            cur.close()
        else:
